...
- Support for diagrams in more text formats, including markdown ([issue #65](../../issues/65) and [issue #91](../../issues/91)).
...
- Support for jlatexmath in separately installable feature ([issue #72](../../issues/72))
