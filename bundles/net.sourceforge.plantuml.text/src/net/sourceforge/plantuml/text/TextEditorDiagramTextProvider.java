...
public class TextEditorDiagramTextProvider extends AbstractTextDiagramProvider {
	...
	public TextEditorDiagramTextProvider(final String diagramPrefix, final String diagramSuffix, final String... fileExtensions) {
