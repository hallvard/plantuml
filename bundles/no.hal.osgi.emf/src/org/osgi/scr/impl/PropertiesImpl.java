 ...
 * </p>
 * <ul>
 *   <li>{@link org.osgi.scr.impl.PropertiesImpl#getAny <em>Any</em>}</li>
 *   <li>{@link org.osgi.scr.impl.PropertiesImpl#getEntry <em>Entry</em>}</li>
 *   <li>{@link org.osgi.scr.impl.PropertiesImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertiesImpl extends MinimalEObjectImpl.Container implements Properties {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ScrPackage.PROPERTIES__ANY:
				return ((InternalEList<?>)getAny()).basicRemove(otherEnd, msgs);
			case ScrPackage.PROPERTIES__ANY_ATTRIBUTE:
