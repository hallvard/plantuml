 ...
 * </p>
 * <ul>
 *   <li>{@link org.osgi.scr.impl.ImplementationImpl#getAny <em>Any</em>}</li>
 *   <li>{@link org.osgi.scr.impl.ImplementationImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.osgi.scr.impl.ImplementationImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImplementationImpl extends MinimalEObjectImpl.Container implements Implementation {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ScrPackage.IMPLEMENTATION__ANY:
				return ((InternalEList<?>)getAny()).basicRemove(otherEnd, msgs);
			case ScrPackage.IMPLEMENTATION__ANY_ATTRIBUTE:
